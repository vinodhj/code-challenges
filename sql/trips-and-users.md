...
SELECT 
  t.request_at AS Day,
  ROUND(IFNULL(c.cancelled_trips, 0) / t.total_trips, 2) AS 'Cancellation Rate'
FROM 
  total_count t
LEFT JOIN 
  cancellation_count c ON t.request_at = c.request_at
WHERE 
